...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-base leading-relaxed font-semibold",
        className
      )}
      {...props}
    />
